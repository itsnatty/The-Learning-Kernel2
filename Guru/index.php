...
<head>
  ...
  <title>The Learnel Kernel | <?=$data['nama_guru']; ?></title>
  <!-- plugins:css -->
          ...
          <li class="nav-item dropdown">
            ...
            <div class="dropdown-menu dropdown-menu-right navbar-dropdown preview-list" aria-labelledby="notificationDropdown">
              <a class="dropdown-item">
                <p class="mb-0 font-weight-normal float-left"> Active Exam Notification
                </p>
    ...
    <div class="container-fluid page-body-wrapper">
      ...
      <nav class="sidebar sidebar-offcanvas" id="sidebar">
        ...
        <!--   <li class="nav-item">
             ...
             <li class="nav-item">
            <a class="nav-link" href="?page=mapel"><img class="menu-icon" src="../vendor/images/menu_icons/02.png" alt="menu icon"> <span class="menu-title">SUBJECTS</span></a>
          </li>
          ...
          <!-- Perangkat -->
            ...
            ?>
                 <li class="nav-item">
                      <a class="nav-link" href="?page=perangkat"><img class="menu-icon" src="../vendor/images/menu_icons/04.png" alt="menu icon"> <span class="menu-title">DEVICE</span></a>
                      </li>  
            <?php
            }else{
            ?>
           ...
           <li class="nav-item">
          <a class="nav-link" data-toggle="collapse" href="#pr" aria-expanded="false" aria-controls="general-pages"> <img class="menu-icon" src="../vendor/images/menu_icons/04.png" alt="menu icon"> <span class="menu-title">DEVICE</span><i class="menu-arrow"></i>
          </a>
          ...
          <?php } ?>
        <li class="nav-item">
            <a class="nav-link" href="?page=perangkat"> <i class="fa fa-file-archive-o"></i>&nbsp; ALL DEVICES</a>
        </li>
            ...
            ?>
         <li class="nav-item">
            <a class="nav-link" data-toggle="collapse" href="#materi" aria-expanded="false" aria-controls="general-pages"> <img class="menu-icon" src="../vendor/images/menu_icons/04.png" alt="menu icon"> <span class="menu-title">THEORY</span><i class="menu-arrow"></i>
            </a>
            <div class="collapse" id="materi">
              <ul class="nav flex-column sub-menu">
                ...
                foreach ($mtri as $mt) { ?>
                  ...
                  <i class="fa fa-file-text">&nbsp;&nbsp;MAJOR</i> &nbsp;&nbsp; <?=$mt['jurusan'];?></a>
                  </li>             
                <?php } ?>          

              <li class="nav-item">
              <a class="nav-link" href="?page=materi">
              <i class="fa fa-file-text"></i> &nbsp;&nbsp;ALL MATERIALS</a>
              </li>
              </ul>
            </div>
          </li>
               <li class="nav-item">
            <a class="nav-link" data-toggle="collapse" href="#tugas" aria-expanded="false" aria-controls="general-pages"> <img class="menu-icon" src="../vendor/images/menu_icons/04.png" alt="menu icon"> <span class="menu-title">STUDENT TASKS</span><i class="menu-arrow"></i>
            </a>
            <div class="collapse" id="tugas">
              <ul class="nav flex-column sub-menu">
                <li class="nav-item">
                   <a class="nav-link" href="?page=tugas"><i class="fa fa-gear"></i> &nbsp;&nbsp; MANAGE TASKS</a>
              </li>
                <li class="nav-item">
                   <a class="nav-link" href="?page=tugas&act=view"><i class="fa fa-pencil"></i> &nbsp;&nbsp;TASK DATA</a>
              </li>
              </li>
              </ul>
            </div>
          ...
          <li class="nav-item">
            <a class="nav-link" data-toggle="collapse" href="#evaluasi" aria-expanded="false" aria-controls="general-pages"> <img class="menu-icon" src="../vendor/images/menu_icons/04.png" alt="menu icon"> <span class="menu-title">QUIZ EXAM</span><i class="menu-arrow"></i>
            </a>
            <div class="collapse" id="evaluasi">
              <ul class="nav flex-column sub-menu">
                <li class="nav-item">
                 	 <a class="nav-link" href="?page=ujian"><img class="menu-icon" src="../vendor/images/menu_icons/06.png" alt="menu icon"> <span class="menu-title">EXAM</span></a>
             	</li>
                <li class="nav-item">
                 	 <a class="nav-link" href="?page=nilai"><img class="menu-icon" src="../vendor/images/menu_icons/04.png" alt="menu icon"> <span class="menu-title">VALUE</span></a>
             	</li>
             	</li>
              </ul>
            </div>
