...
<div class="content-wrapper">
  <h4>
  Exam Class <small class="text-muted">/ Add</small>
  </h4>
  <hr>
  <div class="row">
        ...
        <div class="col-12">
          <div class="card">
			...
			<tbody> 
					...
					<br>
						<label class="form-check-label">
						<input type="checkbox" value="<?=$t['id_kelas']; ?>" name="Class[]">
						KELAS <?=$t['kelas']; ?>
						</label>
						<hr>
...
<button name="testclassSave" type="submit" class='btn btn-primary'>Save</button>
<input type=button value=Cancel onclick=self.history.back() class='btn btn-warning btn-rounded'>
