<div class="content-wrapper">
  <h4>
  Exam <small class="text-muted">/ Add</small>
  </h4>
  <hr>
  <div class="row">
          ...
          <div class="card">
            <div class="card-body">
              ...
              <p class="card-description">
               ...
               <form class="forms-sample" action="?page=proses" method="post" enctype="multipart/form-data">
                ...
                <div class="form-group">
                  ...
                  <input type="text" name="judul" class="form-control" placeholder="Device Title..">
                </div>
                  <div class="form-group">
                 ...
                 <div class="form-group">
                  ...
                  <input type="text" name="menit" class="form-control" placeholder='Minute Exam Length to be filled in 2 digits (00)' maxlength='2' maxlength="2" required>
                </div>
                 <div class="form-group">
                  <label>Number of Questions*</label>
                  <input type="number" name="jumlah" class="form-control" placeholder="Number of Questions ..">
                </div>
                 ...
                 <div class="form-group">
                  ...
                  <option value="no">Non Random</option>
                  </select>
              </div>
              <div class="form-group">
              ...
              <div class="form-group">
                ...
                <button type="submit" name="ujianSave" class="btn btn-info mr-2">Save</button>
                <a href="javascript:history.back()" class="btn btn-danger">Cancelled</a>
              </form>
