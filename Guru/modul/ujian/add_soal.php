<div class="content-wrapper">
  <h4>
  QUESTION <small class="text-muted">/ Add Question</small>
  </h4>
  <hr>
  <div class="row">
            ...
            <div class="card-body">
              ...
              <form class="forms-sample" action="?page=proses" method="post">
                ...
                <div class="form-group">
                  <label for="ckeditor">Question</label>
                  <textarea name="soal" id="ckeditor"></textarea>
                </div>

              <div class="form-group">
              	<label for="p1">Choice A</label>
               ...
               <div class="form-group">
                ...
                <div class="input-group">                          
                 ...
                 <div class="form-group">
				  ...
				  <option value=''>-- answer key--</option>
                ...
                <button type="submit" name="objektifSave" class="btn btn-info mr-2">Save</button>
