...
<h4> <b>EVALUATION</b> <small class="text-muted">/ STUDENT EXAM STATUS</small>
</h4>
<hr>
<?php  
...
<div class="row purchace-popup">
            <div class="col-12">
              ...
              <tr>
              <th colspan="5">EXAM DETAILS <b><?=$d['jenis_ujian'] ?></b></th>
              <th>DATE<b class="text-danger"><?=date('d-F-Y',strtotime($d['tanggal'])) ?></b></th>
              </tr>
              <tr>
              <th>Exam Title</th>
              <th>:</th>
...
<h4>STUDENT LIST<b><?=$klsuj['kelas'] ?> -<?=$klsuj['jurusan'] ?> </b>TAKE THE EXAM</h4>
