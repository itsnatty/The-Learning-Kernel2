...
<div class="row">
  ...
  <strong>Hints!</strong> <br> Click <b>Question Bank</b> To Add Questions.<br>
   Click <b>Exam Status</b> To Open and Close Exams. <br>
   The exam will be active on the Student page, If you set the <b>date</b> on the day on which the exam will be held and the exam status <b>Active</b>
  </div>
                  ...
                  <table class="table table-striped table-hover table-condensed" id="data">
                    ...
                    foreach ($sqlrole as $row) { ?>       
                      ...
                      <tr>
                        ...
                        <td><?=$no++; ?>.</td>
                        <td><?=$row['mapel']; ?> </td>
                        <td><a href="?page=ujian&act=soal&id=<?=$row['id_ujian']; ?>"><b class="text-primary"> <em>OBJECTIVE</em></b></a></td>
                        <td><?=$row['acak']; ?></td>
                        ...
                        <td> 
                          ...
                          <a href="?page=ujian&act=soal&id=<?=$row['id_ujian']; ?>" class="btn btn-primary btn-sm text-white">Number of Questions ( <b><?=$jmlSoal; ?></b> )</a>
                      </td>
                           <td>
                        ...
                        <td>
                          <a data-toggle="modal" data-target="#kelasUjian<?=$row['id_ujian']; ?>" class="btn btn-dark btn-sm text-warning"><i class="fa fa-graduation-cap"></i>CLass </a>
                           ...
                           <!-- Modal -->
                            <div class="modal fade" id="kelasUjian<?=$row['id_ujian']; ?>" tabindex="-1" role="dialog" aria-labelledby="myModalLabel">
                              <div class="modal-dialog" role="document">
                                <div class="modal-content">
                                  <div class="modal-header">
                                    <h4 class="modal-title" id="myModalLabel">Exam Class</h4>
                                  </div>
                            ...
                            <?php 
                                ...
                                foreach ($klesy as $esy);
                                 $jmlesy = mysqli_num_rows($klesy);
                                  if ($jmlesy >0) {
                                    ?>
                                    <a data-toggle="modal" data-target="#tutupEssay<?=$e['id_ujianessay']; ?>" class="btn btn-success btn-sm text-white"><i class="fa fa-check-square-o"></i>  Active </a>
                                    <!-- MODAL TUTUP UJIAN -->
                                    ...
                                    <div class="modal-dialog" role="document">
                                      <div class="modal-content">
                                        ...
                                        <div class="modal-body">                                    
                                           <center>
                                             <a href="?page=ujian&act=closeessay&essayid=<?php echo $e['id_ujianessay']; ?>" class="btn btn-dark"><i class="fa fa-check-square-o"></i> Yes</a>
                                    ...
                                    <a data-toggle="modal" data-target="#AktifEssay<?=$e['id_ujianessay']; ?>" class="btn btn-danger btn-sm text-white">
                                      ...
                                      <i class="fa fa-window-close-o"></i>Closed </a> 
                                           <!-- Modal Aktifkan ujian -->
                                  <div class="modal fade" id="AktifEssay<?=$e['id_ujianessay']; ?>" tabindex="-1" role="dialog" aria-labelledby="myModalLabel">
                                    <div class="modal-dialog" role="document">
                                      <div class="modal-content">
                                        ...
                                        <div class="modal-body">                                    
                                           <center>
                                             <a href="?page=ujian&act=aktifessay&essayid=<?php echo $e['id_ujianessay']; ?>" class="btn btn-dark"><i class="fa fa-check-square-o"></i> Yes</a>
