...
Question Data
   ...
   <div class="row purchace-popup">
                <div class="col-md-12">
                 ...
                 <a href="?page=ujian&act=soaladd&ID=<?=$_GET[id]; ?>" class="btn btn-dark"> <i class="fa fa-plus text-white"></i> Add Question</a>
              ...
              <a href="../Report/soal/print_soal.php?ID=<?=$_GET[id]; ?>" target="_blank" class="btn btn-danger"> <i class="fa fa-download text-white"></i> Download Questions</a>
...
<div class="col-md-12 col-xs-12">
  <div class="card">
                <div class="card-body">
                  <h4 class="card-title">List of Objective Questions</h4>
...
<div class='modal modal-info fade' id="modal_upload">
          <div class='modal-dialog'>
            ...
            <a href="../download/soal_template.xlsx" class="btn btn-success pull-left"><i class="fa fa-file-excel-o"></i>excel example</a>
