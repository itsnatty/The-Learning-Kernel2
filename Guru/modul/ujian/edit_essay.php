    ...
    <div class="col-md-10 col-xs-12 d-flex align-items-stretch grid-margin">
      <div class="row flex-grow">
        <div class="col-12 col-xs-12">
          <div class="card">
            <div class="card-body">
              <h4 class="card-title">Essay Question Form</h4>
              ...
              <form class="forms-sample" action="?page=proses" method="post">
                ...
                <div class="form-group">
                  <label for="ckeditor">Essay Questions</label>
                ...
                <button type="submit" name="essayEdit" class="btn btn-info mr-2">Change</button>
