          ...
          <div class="card-body">
            <div class="clearfix">
              ...
              <div class="float-right">
                <p class="card-text text-right font-weight-bold">Number of Lessons</p>
        ...
        <div class="card card-statistics" style="background-color: #9C27B0;border-radius: 10px;">
          <div class="card-body">
            <div class="clearfix">
              ...
              <div class="float-right">
                <p class="card-text text-right font-weight-bold text-white">Number of Tasks</p>
                <div class="fluid-container">
        ...
        <div class="card card-statistics" style="background-color: #FF5722;border-radius: 10px;">
          <div class="card-body">
            <div class="clearfix">
              ...
              <div class="float-right">
                <p class="card-text text-right font-weight-bold text-white">Amount of Material</p>
                <div class="fluid-container">
        ...
        <div class="card card-statistics" style="background-color: #212121;border-radius: 10px;">
          <div class="card-body">
            <div class="clearfix">
              ...
              <div class="float-right">
                <p class="card-text text-right font-weight-bold text-white">Number of Exams</p>
                <div class="fluid-container">
    ...
    <div class="row">
     ...
     foreach ($mtri as $mtr) { ?>
      <div class="col-md-10">
        ...
        <strong>Info!</strong> You have Shared Material <b><?=$mtr['mapel'] ?></b> Untuk Kelas <b><?=$mtr['kelas'] ?>-<?=$mtr['jurusan'] ?></b>
...
<strong><?php echo $daftar_pesan['nama_siswa']; ?></strong> Class(<?php echo $kls['kelas']; ?>-<?php echo $jrs['jurusan']; ?>) <em style="font-size: 10px;"><?php echo date('d-m-Y',strtotime($daftar_pesan['tanggal'])); ?></em> <br><?php echo $daftar_pesan['isi_pesan']; ?>

</div> 
<p>
  <a href="" class="btn btn-light text-success" data-toggle="modal" data-target="#Apply<?php echo $daftar_pesan['id_pengirim']; ?>"><i class="fa fa-angle-double-right"></i> Reply</a>
...
<div class="modal fade" id="Apply<?php echo $daftar_pesan['id_pengirim']; ?>" tabindex="-1" role="dialog" aria-labelledby="myModalLabel">
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            <div class="modal-header"><h4 class="modal-title"> <b><i class="fa fa-wechat"></i>Reply message</b> </h4></div>
            <form action="" method="post">
                <div class="modal-body"> 
                  ...
                  <div class="form-group">
                    ...
                    <textarea name="isi_pesan" id="ckeditor" class="form-control" rows="5">Write a message</textarea>
                  </div>

                </div>
                <div class="modal-footer">
                <button type="button" class="btn btn-default" data-dismiss="modal">Cancel</button>
                <button name="sendMassage" type="submit" class="btn btn-info"><i class="fa fa-send"></i> Send message</button>
                </div>
                </form>
                  <?php 
...
<form action="" method="post">
  <div class="form-group">
   ...
   <div class="form-group">
    ...
    <textarea name="pesan" class="form-control" rows="5" id="ckeditor1">Write a message</textarea>
  </div>
    <div class="form-group">
      <button name="sendMassageMassal" type="submit" class="btn btn-light"><i class="fa fa-send"></i> Send</button>
    </div>
