...
<div class="content-wrapper">
  ...
  <div class="row">
    ...
    <div class="col-md-9">
        <div class="card">
          <div class="card-body">
            <center>
              <h2>
              APPLICATION ADMIN PANEL <strong>The Learning Kernel</strong> <br>
    ...
    <p class="mt-3 ml-3">
      <h4><i class="fa fa-user text-success"></i> <b class="text-success">User</b> Confirmation</h4>
      <hr>
    </p>
      <div class="mt-3">
      <!-- info daftar guru -->
      <?php
        ...
        if ($d['confirm']=='Yes') {
          ...
          <div class="alert alert-info alert-dismissible" role="alert">
              ...
              <strong><?=$d['nama_guru'] ?>!</strong> Create Account <em><a href="" data-toggle="modal" data-target="#guru<?=$d['id_guru'] ?>"> Confirmation</a></em>
          </div>
              ...
              <!-- modal edit -->
                            ...
                            <div class="modal-content">
                                <div class="modal-header"><h4 class="modal-title"> Registrant Information </h4></div>
        ...
        <strong><?=$d['nama_siswa'] ?>!</strong> Create Account <em><a href="" data-toggle="modal" data-target="#siswa<?=$d['id_siswa'] ?>"> Confirmation</a></em>
        </div>
                                ...
                                <tr>
                                  ...
                                  <tr>
                                   ...
                                   <tr>
                                    ...
                                    <div class="modal-footer">        
                                    <a href="?page=siswa&act=unconfirm&id=<?=$d['id_siswa']; ?>" class="btn btn-danger">Reject</a>
                                    <a href="?page=siswa&act=confirm&id=<?=$d['id_siswa']; ?>" class="btn btn-success"> agree</a>                                  
                                    </div>
