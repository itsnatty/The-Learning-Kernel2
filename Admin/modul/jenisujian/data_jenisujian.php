<div class="content-wrapper">
    <h4> <b>Master</b> <small class="text-muted">/ Exam Type</small>
    </h4>
    <hr>
    <div class="row">
        <div class="col-md-10">
            <div class="card">
                ...
                <h4 class="card-title">Exam Type Data</h4>
                    <div class="table-responsive">
                        ...
                        <tr>
                            ...
                            <div class="modal-content">
                                <div class="modal-header"><h4 class="modal-title"> Edit Test Type </h4></div>
                                <form action="" method="post">
                                    <div class="modal-body">
                                        <div class="form-group">
                                        <label for="mapel"> Test Type</label>
...
<div class="modal fade" id="add" tabindex="-1" role="dialog" aria-labelledby="myModalLabel">
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            <div class="modal-header"><h4 class="modal-title"> Add Test Type </h4></div>
            <form action="" method="post">
                <div class="modal-body">
                    <div class="form-group">
                    <label for="mapel"> Test Type</label>
