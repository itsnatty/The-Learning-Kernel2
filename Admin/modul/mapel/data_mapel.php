<div class="content-wrapper">
    <h4> <b>Master</b> <small class="text-muted">/ course</small>
    </h4>
    <hr>
    <div class="row">
        <div class="col-md-10">
            <div class="card">
                ...
                <a data-toggle="modal" data-target="#add" class="btn btn-info text-white pull-right"><i class="fa fa-plus"></i> Add folder</a> <br>
                </p>
                <h4 class="card-title">Folder data</h4>
                    <div class="table-responsive">
                        ...
                        <tr>
                            ...
                            <div class="modal-content">
                                <div class="modal-header"><h4 class="modal-title">Edit folder </h4></div>
                                <form action="" method="post">
                                    <div class="modal-body">
                                        <div class="form-group">
                                        <label for="mapel"> Course name</label>
...
<div class="modal fade" id="add" tabindex="-1" role="dialog" aria-labelledby="myModalLabel">
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            <div class="modal-header"><h4 class="modal-title"> Add folder</h4></div>
            <form action="" method="post">
                <div class="modal-body">
                    <div class="form-group">
                    <label for="mapel"> Course name</label>
