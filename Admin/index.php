...
<head>
  ...
  <title>The Learning Kernel | <?=$data['nama_lengkap']; ?></title>
  <!-- plugins:css -->
...
<!-- 
          ...
          <li class="nav-item">
            ...
            <div class="collapse" id="masterData" style="background-color:#212121;">
              ...
              <li class="nav-item">
                    ...
                    <i class="fa fa-angle-double-right" style="font-size:20px;color:#fff;"></i> &nbsp;<span class="menu-title">Master Major</span></a>
               </li>
               ...
               <li class="nav-item">
                    ...
                    <i class="fa fa-angle-double-right" style="font-size:20px;color:#fff;"></i> &nbsp;<span class="menu-title">Master Type Lesson</span></a>
               </li>

               <li class="nav-item">
                 	 <a class="nav-link" href="?page=jenisujian" style="color:#fff;">
                    <i class="fa fa-angle-double-right" style="font-size:20px;color:#fff;"></i> &nbsp;<span class="menu-title">Master Type Exam</span></a>
               </li>

               <li class="nav-item">
                 	 <a class="nav-link" href="?page=jenisperangkat" style="color:#fff;">
                    <i class="fa fa-angle-double-right" style="font-size:20px;color:#fff;"></i> &nbsp;<span class="menu-title">Master Type Device</span></a>
               </li>
              ...
              <ul class="nav flex-column sub-menu">
                ...
                <li class="nav-item">
                    ...
                    <i class="fa fa-user-circle" style="font-size:20px;color:#fff;"></i> &nbsp;&nbsp;
                       <span class="menu-title">TEACHER</span></a>
             	</li>
                <li class="nav-item">
                 	 <a class="nav-link" href="?page=siswa" style="color:#fff;">
                    <i class="fa fa-user-circle-o" style="font-size:20px;color:#fff;"></i> &nbsp;&nbsp;<span class="menu-title">STUDENT</span></a>
             	</li>
             	</li>
              </ul>
            </div>
      ...
      <li class="nav-item">
                   <a class="nav-link" href="?page=setting">
                    <i class="fa fa-gears" style="font-size:20px;"></i> &nbsp;&nbsp;<span class="menu-title">APPLICATION SET</span></a>
              </li>
