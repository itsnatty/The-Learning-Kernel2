<div class="content-wrapper">
    <h4> <b>Evaluation</b> <small class="text-muted">/Question</small>
    </h4>
    <hr>
    <div class="row">
      <div class="col-md-12">
                        ...
                        <div class="modal-dialog modal-lg" role="document">
                          <div class="modal-content">
                            ...
                            <div class="modal-footer">
                              ...
                              <a href="../Report/soal/print_soal.php?ID=<?=$s[id_ujian]; ?>" target="_blank" class="btn btn-primary"> <i class="fa fa-download text-white"></i> Download Questions</a>
                            </div>
                          </div>
                        </div>
                      </div>
                      ...
                      <div class="modal fade bs-example-modal-lg" id="soalEssay<?php echo $s['id_ujianessay'] ?>" tabindex="-1" role="dialog" aria-labelledby="myModalLabel">
                        <div class="modal-dialog modal-lg" role="document">
                          <div class="modal-content">
                            ...
                            <div class="modal-footer">
                              <button type="button" class="btn btn-default" data-dismiss="modal">Close</button>
                              <a href="../Report/soal/print_soalessay.php?ID=<?=$s[id_ujianessay]; ?>" target="_blank" class="btn btn-primary"> <i class="fa fa-download text-white"></i> Download Questions</a>
                            </div>
                          </div>
                        </div>
                      </div>
