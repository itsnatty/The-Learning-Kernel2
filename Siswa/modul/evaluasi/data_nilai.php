  <div class="content-wrapper">
                <h4> <b>Evaluation</b> <small class="text-muted">/Score</small>
                </h4>
                <hr>
                <div class="row">
                  <div class="col-md-12">
  ...
  <table class="table table-striped table-hover">
   ...
   while($r = mysqli_fetch_array($qujian)){ ?>
      ...
      <td bgcolor="#00BCD4" style="color:#fff;">
      	<a data-toggle="modal" data-target="#viewNilai<?=$m['id_ujian'] ?>" class="btn btn-block" style="font-weight:bold;"><i class="fa fa-search"></i> View Value</a>
				<!-- Modal -->
				<div class="modal fade" id="viewNilai<?=$m['id_ujian'] ?>" tabindex="-1" role="dialog" aria-labelledby="myModalLabel">
				  <div class="modal-dialog" role="document">
				    <div class="modal-content">
				      <div class="modal-header">
				        <h4 class="modal-title" id="myModalLabel">Capital title</h4>
				      </div>
