...
<h4> <b>Evaluation</b> <small class="text-muted">/Exam Information</small>
</h4>
<hr>
<div class="row">
<div class="col-md-12">
    <div class="card">
      <div class="card-body">
        <h4 class="text-heading">EXAM LIST</h4>
        <p></p>
        <hr>
...
if($tujian < 1){
   echo '
   <div class="alert alert-info">There are no exams on the current date for your class. If there is an error contact the Subject Teacher! fix exam date or exam class</div>';
}
...
//Jika ada dua atau lebih ujian aktif tampilkan pada tabel
   ...
   while($r = mysqli_fetch_array($qujian)){
    ...
    <a href="index.php?page=evaluasi&act=nilai"><i class="fa fa-file-text"></i><b>View Value</b> </a>';

    elseif($tnilai>0 and $rnilai['sisa_waktu'] != "")
    echo '<td bgcolor="#FF3300">
    <a href="index.php"> <i class="btn btn-block"><i class="fa fa-check-circle-o"></i> Continue</a>';

    else echo '
    <td bgcolor="#FFFF00">
    <a href="index.php"><i class="fa fa-home"></i>Click button <b>Kerjakan</b> on exams that are active on the main page</a>';
    echo '</td>
    </tr>';
...
if($ujessay < 1){
   echo '
   <div class="alert alert-info">There are no Essay exams on the current date for your class. If there is an error contact the Subject Teacher! fix exam date or exam class</div>';
}
...
<h4 class="card-title">Essay Exam</h4>
<table class="table table-striped">     
  <tbody>
   ...
   <td bgcolor=bordercolordark="#00FF33">
    <a href="" data-toggle="modal" data-target="#soalEssay<?php echo $e['id_ujianessay'] ?>"><i class="fa fa-edit"></i> View Question</a>
    ...
    <div class="modal-dialog modal-lg" role="document">
      <div class="modal-content">
        ...
        <div class="modal-footer">
          ...
          <a href="../Report/soal/print_soalessay.php?ID=<?=$e[id_ujianessay]; ?>" target="_blank" class="btn btn-primary"> <i class="fa fa-download text-white"></i> Download Questions</a>
        </div>
      </div>
    </div>
  </div>
