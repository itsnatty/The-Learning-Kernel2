...
echo '<div class="error">ERROR:File upload failed!</div>';
}

}else{
echo '<div class="error">ERROR:Large file size (file size) a maximum of 2 Mb!</div>';
}

}else{

echo '<div class="error">ERROR:File type not allowed!</div>';
...
echo '<div class="error">ERROR: Failed to upload file!</div>';
}

}else{
echo '<div class="error">ERROR:Large file size (file size) maximum 1 Mb!</div>';
}

}else{

echo '<div class="error">ERROR:File extension not allowed!</div>';
