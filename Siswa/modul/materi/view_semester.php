...
<div class="row">
	<div class="col-lg-12 grid-margin stretch-card">
              <div class="card">
                <div class="card-body">
                  <h4 class="card-title">LIST OF MATERIALS<b><?= $_GET['semester']; ?></b></h4>
                      ...
                      <tr style="border-top: 2px solid black;">
                        ...
                        <td>
                          ...
                          <?php if ($row['tipe_file']=='text') {
                           ?>
                           <a href="../Report/materi/materi-words.php?ID=<?php echo $row['id_materi'];?>" target="_blank" class="btn btn-light btn-rounded btn-fw text-info"><i class="fa fa-download"></i> download.<?php echo $row['tipe_file']; ?> </a>
                           <?php
                          } else{
                            ?>
                            <a href="<?=$row['file']; ?>" target="_blank" class="btn btn-light btn-rounded btn-fw text-info"><i class="fa fa-download"></i> download.<?php echo $row['tipe_file']; ?> </a>
                            <?php
                          }
                        ...
                        <div class="modal-content">
                          <div class="modal-header">
                            ...
                            LEARNING MATERIALS<br>
                              <img class="menu-icon" src="../vendor/images/menu_icons/04.png" alt="menu icon"> <b> <?=$row['judul_materi']; ?></b> | <?=$row['mapel']; ?> CLASS <?=$row['kelas']; ?>-<?=$row['jurusan']; ?> </h4>
                              <hr>
                          </div>
