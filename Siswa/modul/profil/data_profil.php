...
$d = mysqli_fetch_array($sqld);
 ...
 <div class="row">
              ...
              <div class="row flex-grow">
                <div class="col-12">
                  <div class="card">
                    ...
                    <div class="form-group">
                      <label>Class  <?php if (empty($d['id_kelas'])) {
                        echo "<em class='text-danger'> [ Class Not yet selected ! ] </em>";
                      } ?></label>
      ...
      <div class="form-group">
                  <label for="jurusan">Major<?php if (empty($d['id_jurusan'])) {
                        echo "<em class='text-danger'> [ Course Not selected! ] </em>";
                      } ?></label>
                  ...
                  ?>
                    ...
                    <a href="javascript:history.back()" class="btn btn-light">Cancelled</a>
                  </form>
