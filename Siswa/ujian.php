...
if(mysqli_num_rows($qsoal)==0) die('<div class="alert alert-warning">There are no questions in this exam</div>');
...
//6 Membuat array pilihan dan mengacak pilihan
   $arr_pilihan = array();
   $arr_pilihan[] = array("no" => 1, "choice" => $rsoal['pilihan_1']);
   $arr_pilihan[] = array("no" => 2, "choice" => $rsoal['pilihan_2']);
   $arr_pilihan[] = array("no" => 3, "choice" => $rsoal['pilihan_3']);
   $arr_pilihan[] = array("no" => 4, "choice" => $rsoal['pilihan_4']);
   $arr_pilihan[] = array("no" => 5, "choice" => $rsoal['pilihan_5']);
...
<div class="container1" style="margin-left:-30px;">
   ...
   <button class="btn btn-default btn-prev" ><i class="fa fa-chevron-circle-left"></i> PREVIOUS QUESTION</button>
      
     </a></div>';
   echo '    <div><label class="labele" style="padding-bottom:10px; padding-top:10px; width:225px">
    <input type="checkbox" autocomplete="off" onchange="ragu_ragu('.$no.')">&nbsp;DOUBTFUL</label>
	</div>';
	
   $berikutnya = $no+1;
   if($no != count($arr_soal)) echo ' <div><a onclick="tampil_soal('.$berikutnya.')">
<button class="btn btn-primary btn-next activebutton"  style="margin-top:-13px; width:225px"><i class="fa fa-chevron-circle-right"></i>NEXT QUESTION</button>                     
               </a></div>';
   else echo ' <div><a  onclick="selesai()">
<button class="btn btn-danger btn-next activebutton"  style="margin-top:-13px; width:225px"> <i class="fa fa-check-circle-o"></i> DONE</button>                     
                 </a></div>';
...
Please click the <b>FINISH</b> button to end the test.
			</p>
      </div>
      <div class="modal-footer">
        <button type="submit" class="btn btn-success"  onclick="return selesai_ujian('.$_GET['ujian'].')">DONE</button>
