...
<h3 class="list-group-item-heading page-label">Exam Information</h3></div>
  ...
  <div id="myerror" class="alert alert-warning" role="alert" style="font-size: 13px; font-style:normal; font-weight:normal">
    ...
    <font size="3px">It will take a little time, Please Be Patient * if you haven't finished the exam and time is up then our score is blank</font>
    </div>
...
<button type="submit" class="btn btn-danger btn-lg doblockui"><i class="fa fa-edit"></i> Do the Problem</button></a></center>';
?>
    </div>  
</div>
