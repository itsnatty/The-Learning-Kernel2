...
<h4 class="list-group-item-heading page-label">Your Value</h4></div>
...
<Center><p> Score :</p>
     ...
     <a href="index.php"><button class="btn btn-info btn-block doblockui">return</button></a>
 </Center>   
    </div>
  </div> 
   <div class="kanan">
...
<font size="3px">Top 10 Rank</font>
	</div>
