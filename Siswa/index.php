...
<head>
  ...
  <title>The Leaning Kernel | <?=$data['nama_siswa']; ?></title>
  <!-- plugins:css -->
        ...
        <ul class="navbar-nav navbar-nav-right">
          ...
          <li class="nav-item dropdown">
            ...
            <div class="dropdown-menu dropdown-menu-right navbar-dropdown preview-list" aria-labelledby="notificationDropdown">
                ...
                <p class="mb-0 font-weight-normal float-left"><b><?=$jmlh; ?></b> Subjects
                </p>
    ...
    <div class="container-fluid page-body-wrapper">
      ...
      <nav class="sidebar sidebar-offcanvas" id="sidebar">
        <ul class="nav">
          ...
          <li class="nav-item">
           ...
           <li class="nav-item">
            <a class="nav-link" data-toggle="collapse" href="#menuMateri" aria-expanded="false" aria-controls="general-pages"> <img class="menu-icon" src="../vendor/images/menu_icons/04.png" alt="menu icon"> <span class="menu-title">MATERIAL</span><i class="menu-arrow"></i>
            </a>
            ...
            <?php } ?>
               ...
               <li class="nav-item">
                  <a class="nav-link" href="?page=materi"><img class="menu-icon" src="../vendor/images/menu_icons/04.png" alt="menu icon">ALL MATERIALS</a>
              </li>
               ...
               <li class="nav-item">
          <a class="nav-link" href="?page=tugas"><img class="menu-icon" src="../vendor/images/menu_icons/04.png" alt="menu icon"> <span class="menu-title">TASK </span></a>
          </li>

          <li class="nav-item">
            <a class="nav-link" data-toggle="collapse" href="#menuEvaluasi" aria-expanded="false" aria-controls="general-pages"> <img class="menu-icon" src="../vendor/images/menu_icons/04.png" alt="menu icon"> <span class="menu-title">EVALUATION</span><i class="menu-arrow"></i>
            </a>
            <div class="collapse" id="menuEvaluasi">
              <ul class="nav flex-column sub-menu">
                   <li class="nav-item">
                    <a class="nav-link" href="?page=ujian" style="font-size: 15px;"><i class="fa fa-info-circle"></i>&nbsp; EXAM INFO</a>
              </li>
               <li class="nav-item">
                    <a class="nav-link" href="?page=evaluasi&act=nilai" style="font-size: 15px;"><i class="fa fa-file-text"></i>&nbsp;SCORE LIST</a>
              </li>
               <li class="nav-item">
                  <a class="nav-link" href="?page=evaluasi" style="font-size: 15px;"><i class="fa fa-language"></i>&nbsp; QUESTION LIST</a>
              </li> 
      ...
      <div class="main-panel">
           ...
           <!-- Konten -->
                ...
                <h3> <b>Dashboard</b> <small class="text-muted">/Student</small>
                </h3>
                <hr>
                <div class="row">
                  <div class="col-md-12">
